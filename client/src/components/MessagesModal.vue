    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          >
            <div 
              :class="'p-2 border rounded mb-2 border-secondary ' + (msg.fromId == userId ? 'float-start' : 'float-end') ">
              {{ msg.text }}
            </div>
          </div>
        ...
        <div class="modal-footer d-block">
          <div class="row">
            ...
            <div class="col-2">
              <button type="button" class="btn btn-primary" @click="sendMessage()">Отп</button>
            </div>
          </div>
        </div>
      </div>
